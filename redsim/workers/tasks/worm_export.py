"""redsim.export_chains_to_worm — periodic WORM export of audit chains.
...
``REDSIM_WORM_EXPORT`` is not enabled it early-returns ``{"status":
...
@app.task(name="redsim.export_chains_to_worm")
