"""Redsim domain schema: ``RedsimFinding``, ``CodeLocation``, and the shared
...
class RedsimFinding(BaseModel):
    ...
    @classmethod
    def from_dict(cls, d: dict) -> RedsimFinding:
        ...
        try:
            ...
            logger.warning(
                "RedsimFinding.from_dict: blob failed validation (id=%r), loading "
