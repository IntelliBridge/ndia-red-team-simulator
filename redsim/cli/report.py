"""`redsim report` — generates Markdown / JSON / HTML reports."""
...
def cmd_report(args: argparse.Namespace, config: RedsimConfig) -> None:
    """Generate Markdown / JSON / HTML reports — thin shell over the service."""
    from redsim.services.reports import render_reports
