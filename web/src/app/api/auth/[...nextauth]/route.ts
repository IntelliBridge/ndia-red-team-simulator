...
//     signed with REDSIM_API_SESSION_PRIVATE_KEY → FastAPI verifies
//     against the matching public key.
//   - `redsim_csrf` (NOT httpOnly so JS can read it) used by the
//     SPA's api() helper as the X-Redsim-CSRF header on every
