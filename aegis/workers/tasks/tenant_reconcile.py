"""aegis.verify_tenant_integrity — periodic tenant-isolation reconciliation.
...
decision (the on-demand ``aegis tenants verify --repair`` CLI can backfill from
...
def _register_task() -> Any:
    ...
    @app.task(name="aegis.verify_tenant_integrity")
