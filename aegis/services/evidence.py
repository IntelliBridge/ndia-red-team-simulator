...
ISO 27001 / FedRAMP reviewer can inspect offline:
    ...
    <out_dir>/
      ...
      system.json              Aegis version + enabled-features summary
...
Aegis genuinely ships, and marks anything incomplete ``"partial"``. It is
...
# concrete Aegis features that supply evidence. Only controls Aegis genuinely
