<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F004 Run Management. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F004 Run Management (`specs/004-run-management/spec.md`)
- Product owner / date:
