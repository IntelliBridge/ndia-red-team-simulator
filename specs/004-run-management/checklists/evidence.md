...
| SC-003 | amended | Zero execution in the web process | `tests/test_api_process_has_no_ml.py::test_api_app_builds_with_ml_libraries_blocked`, `::test_sandbox_child_env_allowlist_excludes_gateway_and_cloud_credentials`, `tests/e2e/test_ml_verify_upload_reports.py::test_api_process_admits_uploads_without_importing_ml` | unit, e2e |
