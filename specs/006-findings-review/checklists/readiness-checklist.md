<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F006 Findings Review. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F006 Findings Review (`specs/006-findings-review/spec.md`)
- Product owner / date:
