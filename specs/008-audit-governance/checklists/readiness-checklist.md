<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F008 Audit and Governance. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F008 Audit and Governance (`specs/008-audit-governance/spec.md`)
- Product owner / date:
