...
| SC-001 | amended | Every report displays its limitations and the partial-run label | `tests/ml/test_report.py::test_six_sections_in_order`, `::test_partial_and_unscored_records_refuse_to_invent_numbers`, `tests/ml/test_reports_phase_b.py::test_pdf_partial_record_says_mri_not_computed`, `tests/ml/test_campaign.py::test_limitations_carry_the_d3_bounds_statement_after_the_standing_text`, `tests/e2e/test_ml_upload_reports.py::test_reports_sections_and_completion_pdf` | ml, e2e |
