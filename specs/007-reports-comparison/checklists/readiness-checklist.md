<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F007 Reports and Comparison. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F007 Reports and Comparison (`specs/007-reports-comparison/spec.md`)
- Product owner / date:
