<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F001 Project Access. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F001 Project Access (`specs/001-project-access/spec.md`)
- Product owner / date:
