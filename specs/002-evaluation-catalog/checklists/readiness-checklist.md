<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F002 Evaluation Catalog. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F002 Evaluation Catalog (`specs/002-evaluation-catalog/spec.md`)
- Product owner / date:
