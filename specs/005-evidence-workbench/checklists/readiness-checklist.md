<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F005 Evidence Workbench. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F005 Evidence Workbench (`specs/005-evidence-workbench/spec.md`)
- Product owner / date:
