...
| SC-003 | unchanged | A baseline-versus-evaluated comparison is available from the workbench without raw storage references | `tests/ml/test_compare.py::test_incompatible_score_unavailable_and_side_by_side`, `tests/ml/test_reports_phase_b.py::test_n_run_table_rows_in_request_order_without_a_delta`, `tests/e2e/test_ml_review_reports.py::test_compare_three_runs_table` (side by side, no delta: the verify paradigm was removed on 2026-09-09), `tests/ml/test_artifacts_api.py::test_stream_headers_and_404s` (artifacts are served by id, never by blob key) | ml, e2e |
