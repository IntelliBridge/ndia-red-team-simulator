<!-- Copied from specs/_shared/readiness-checklist.md on 2026-09-09 for F003 Evaluation Profiles. Every box is unchecked. Only the named reviewers check a box. Generation is not approval. -->
...
- Feature: F003 Evaluation Profiles (`specs/003-evaluation-profiles/spec.md`)
- Product owner / date:
