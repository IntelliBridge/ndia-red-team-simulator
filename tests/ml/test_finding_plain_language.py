...
def test_llm_lead_and_description_start_with_the_plain_account() -> None:
    ...
    assert lead.startswith("What happened: redsim sent the model 16 prompts from the 'dan.Dan_11_0' probe")
    assert "make it disregard the system prompt" in lead and "4 of the 16 replies (25%)" in lead
