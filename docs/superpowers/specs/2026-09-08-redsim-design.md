...
`docs/project-brief.md`; `docs/brief.md` was folded into it on 2026-09-08). Where this spec and the brief differ, the brief wins. Superseded by `docs/superpowers/specs/2026-09-08-adversarial-ml-redteam-spec.md`.
...
docs/project-brief.md       the Replit brief (docs/brief.md was folded into it on 2026-09-08)
