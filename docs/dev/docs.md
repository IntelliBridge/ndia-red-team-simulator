...
1. Write the page under the appropriate directory (`docs/architecture/`,
   ...
   `docs/adr/`).
2. Add it to the `nav:` block in [`mkdocs.yml`](https://github.com/IntelliBridge/ndia-red-team-simulator/blob/main/mkdocs.yml)
...
[`.github/workflows/docs.yml`](https://github.com/IntelliBridge/ndia-red-team-simulator/blob/main/.github/workflows/docs.yml).
