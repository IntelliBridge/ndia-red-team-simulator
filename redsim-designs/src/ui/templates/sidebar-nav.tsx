  ...
  return (
    <aside className="hidden w-56 shrink-0 flex-col border-r border-hairline bg-panel md:flex">
      <div className="flex h-14 items-center gap-2 border-b border-hairline px-4">
        ...
        <span className="text-sm font-semibold leading-tight text-foreground">{BRAND_LONG}</span>
      </div>
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-panel-2 text-foreground" : "text-muted hover:bg-panel-2 hover:text-foreground",
                  )}
                >
