  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors duration-150 disabled:pointer-events-none disabled:opacity-45",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-panel-2 text-foreground border border-hairline hover:bg-hairline",
        ghost: "bg-transparent text-muted hover:bg-panel-2 hover:text-foreground",
        outline: "bg-transparent text-foreground border border-hairline hover:border-primary hover:text-primary",
